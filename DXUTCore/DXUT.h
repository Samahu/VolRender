...
typedef void    (CALLBACK *LPDXUTCALLBACKSHUTDOWN)( void* pUserContext );
...
void WINAPI DXUTSetCallbackShutdown( LPDXUTCALLBACKSHUTDOWN pCallback, void* pUserContext = NULL );
