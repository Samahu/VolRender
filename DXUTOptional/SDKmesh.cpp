...
//-----------------------------------------------------------------------------
HRESULT CDXUTXFileMesh::Create( LPDIRECT3DDEVICE9 pd3dDevice, LPCWSTR strFilename, bool computeNormals )
{
    WCHAR strPath[MAX_PATH];
    ...
    if(computeNormals && !( m_pMesh->GetFVF() & D3DFVF_NORMAL))
    {
        ID3DXMesh* pTempMesh;
	...
	// Uncomment to save to a binary format
	//WCHAR binFilename[MAX_PATH];
	//	swprintf_s(binFilename, MAX_PATH, L"bin_%s", strFilename);
	//	V( D3DXSaveMeshToX(
	//		binFilename,
	//		m_pMesh,
	//		(DWORD*)pAdjacencyBuffer->GetBufferPointer(),
	//		(D3DXMATERIAL*)pMtrlBuffer->GetBufferPointer(),
	//		NULL,
	//		m_dwNumMaterials,
