...
CBaseCamera::CBaseCamera()
{
	...
	SetProjParamsPerspective( D3DX_PI / 4, 1.0f, 1.0f, 1000.0f );
...
//--------------------------------------------------------------------------------------
VOID CBaseCamera::SetProjParamsPerspective( FLOAT fFOV, FLOAT fAspect, FLOAT fNearPlane,
                                 FLOAT fFarPlane )
{
...
// Calculates the projection matrix based on input params
//--------------------------------------------------------------------------------------
VOID CBaseCamera::SetProjParamsOrtho( FLOAT fWidth, FLOAT fHeight, FLOAT fNearPlane,
                                 FLOAT fFarPlane )
{
    // Set attributes for the projection matrix
	...
	D3DXMatrixOrthoLH( &m_mProj, fWidth, fHeight, fNearPlane, fFarPlane );
}
