...
public:
    ...
    virtual void    SetProjParamsPerspective( FLOAT fFOV, FLOAT fAspect, FLOAT fNearPlane, FLOAT fFarPlane );
	virtual void	SetProjParamsOrtho( FLOAT fWidth, FLOAT fHeight, FLOAT fNearPlane, FLOAT fFarPlane );
...
protected:
	...
	float m_fOrthoWidth;          // Field of view
    float m_fOrthoHeight;         // Aspect ratio
    float m_fOrthoNearPlane;      // Near plane
    float m_fOrthoFarPlane;       // Far plane
